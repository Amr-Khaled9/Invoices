                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                            href="{{ route('show_all') }}">قراءة الكل</a>
                                    </span>
                                </div>
                                <h6 id="notification_count">
                                    <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك الاشعارات
                                        غير
                        ...
                        @can('الاشعارات')
                            ...
                            {{-- @if (auth()->user()->role_name == 'owner' || auth()->user()->id == auth()->user()->notifiable_id) --}}
                            <div id="unreadNotifications">
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            href="{{ route('invoices_details.edit', $notification->data['id']) }}">
                                            <input type="hidden" name="{{ $notification->notifiable_id }}">
                                            ...
                                            <div class="mr-3">
                                                <h5 class="notification-label mb-1">
                                                    {{ $notification->data['title'] ?? 'تمت إضافة فاتورة' }} :
