                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        الارشيف</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('invoices.print_invoice', $invoice->id) }}">طباعة فاتورة</a>
                                                </div>
                                            </div>
...
@section('js')
    ...
    <script>
        $('#Transfer_invoice').on('show.bs.modal', function(event) {
            ...
            var invoice_id = button.data('invoice_id'); // يجيب ID
            var modal = $(this);

            modal.find('#invoice_id').val(invoice_id); // يحطه في الـ input hidden
        });
    </script>
@endsection
