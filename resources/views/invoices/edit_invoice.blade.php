                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" id="section_id" class="form-control SlectBox">
                                    <option value="{{$invoice->section->id}}" selected hidden>{{$invoice->section->section_name}}</option>
                            ...
                            <div class="col">
                                ...
                                <select id="product_id" name="product_id" class="form-control">
                                    <option value="{{$invoice->product}}" selected hidden>{{$invoice->product}}</option>
                                </select>
                            </div>
